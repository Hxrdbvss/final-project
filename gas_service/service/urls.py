...
from .views import (
    ...
    create_engineer, get_available_dates, get_available_engineers  # Добавляем импорты
)
...
urlpatterns = [
    ...
    path('api/requests/available-dates/', get_available_dates, name='available-dates'),
    path('api/admin/requests/', ServiceRequestViewSet.as_view({'get': 'list'}), name='admin-requests'),
    path('api/requests/available-engineers/', get_available_engineers, name='available-engineers'),
]
